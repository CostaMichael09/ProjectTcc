    ...
    <div class="col-10">
      ...
      <div v-if="taskContext.taskInstance">
        <akip-show-task-instance :taskInstance="taskContext.taskInstance">
          <template v-slot:body>
            ...
            <div class="form-group">
              <label class="form-control-label" v-text="$t('newProjectApp.taskIncluirFotos.fotos')">fotos</label>
              <input
                readonly
                type="text"
                class="form-control"
        ...
        <router-link
          ...
          :to="`/process-definition/EmpresaVeiculoProcess/task/TaskIncluirFotos/${taskContext.taskInstance.id}/execute`"
          tag="button"
...
<script lang="ts" src="./task-incluir-fotos-details.component.ts"></script>
